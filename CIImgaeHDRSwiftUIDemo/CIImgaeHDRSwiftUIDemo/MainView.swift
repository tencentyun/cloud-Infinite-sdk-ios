...
struct MainView: View {
            ...
            GeometryReader { geometry in
                VStack(spacing: 0) {
                    ...
                    if isEditing {
                        ...
                        ImageView(asset: selectedAsset ?? defaultAsset)
            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .primaryAction) {
                    if isEditing {
                        ...
                        .disabled(selectedAsset == nil && defaultAsset == nil)
                        Button {
                            saveEdit()
                        } label: {
                            Text("Save")
    ...
    func toggleEdit() {
        ...
        guard let asset = selectedAsset ?? defaultAsset else { return }
    ...
    func loadDefaultImage() {
        // 从 Bundle 中加载默认图片
        self.defaultAsset = Asset.loadFromBundle(resource: "湖面HDR", withExtension: "jpg")
    }
}
