...
avifResult avifImageYUVToNV21LibYUV(const avifImage *image, uint8_t *dst_y,
                                    int dst_stride_y,
                                    uint8_t *dst_vu,
                                    int dst_stride_vu);
...
avifCodec * avifCodecCreateVAV1(void);     // requires AVIF_CODEC_SVT (codec_vav1.c)
const char * avifCodecVersionVAV1(void);   // requires AVIF_CODEC_SVT (codec_vav1.c)
